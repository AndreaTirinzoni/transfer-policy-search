...
def simulation(env, num_episodes, batch_size, discount_factor, episode_length, variance_action, seed):
    ...
    return [reinforce, reinforce_baseline, gpomdp, optimal]
...
results = Parallel(n_jobs=2)(delayed(simulation)(env, num_episodes, batch_size, discount_factor, episode_length, variance_action, seed) for seed in seeds)
