...
mean_alg4 = np.mean(discounted_reward_reinforce, axis=0)
...
var_alg4 = np.std(discounted_reward_reinforce, axis=0) / (m.sqrt(runs))
...
mean_pol4 = np.mean(policy_param_reinforce, axis=0)
...
var_pol4 = np.std(policy_param_reinforce, axis=0) / (m.sqrt(runs))

x = range(num_batch)

plot.plot_curves([x, x, x] , [mean_alg1, mean_alg2, mean_alg4], [var_alg1, var_alg2, var_alg4], title = "Rewards over batches", x_label = "Batch", y_label = "Discounted reward", names = ["REINFORCE with transfer (IS)", "REINFORCE with transfer (PD-IS)", "REINFORCE"], file_name = "Rewards transfer policy search")
plot.plot_curves([x, x, x] , [mean_pol1, mean_pol2, mean_pol4], [var_pol1, var_pol2, var_pol4], title = "Policy parameter over batches", x_label = "Batch", y_label = "Policy parameter", names = ["REINFORCE with transfer (IS)", "REINFORCE with transfer (PD-IS)", "REINFORCE"], file_name = "Policy parameter transfer policy search")
