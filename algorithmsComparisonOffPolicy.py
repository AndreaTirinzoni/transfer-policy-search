...
##
### Gradients
##mean_alg1 = np.mean(gradient_off_policy_importance_sampling, axis=0)
##mean_alg2 = np.mean(gradient_off_policy_importance_sampling_pd, axis=0)
##mean_alg3 = np.mean(gradient_off_policy_multiple_importance_sampling, axis=0)
##mean_alg4 = np.mean(gradient_off_policy_multiple_importance_sampling_pd, axis=0)
##mean_alg5 = np.mean(gradient_reinforce, axis=0)
##
##var_alg1 = np.std(gradient_off_policy_importance_sampling, axis=0) / (m.sqrt(runs))
##var_alg2 = np.std(gradient_off_policy_importance_sampling_pd, axis=0) / (m.sqrt(runs))
##var_alg3 = np.std(gradient_off_policy_multiple_importance_sampling, axis=0) / (m.sqrt(runs))
##var_alg4 = np.std(gradient_off_policy_multiple_importance_sampling_pd, axis=0) / (m.sqrt(runs))
##var_alg5 = np.std(gradient_reinforce, axis=0) / (m.sqrt(runs))
##
...
##mean_alg1 = np.mean(ess_off_policy_importance_sampling, axis=0)
##mean_alg2 = np.mean(ess_off_policy_importance_sampling_pd, axis=0)
##mean_alg3 = np.mean(ess_off_policy_multiple_importance_sampling, axis=0)
##mean_alg4 = np.mean(ess_off_policy_multiple_importance_sampling_pd, axis=0)
##
##var_alg1 = np.std(ess_off_policy_importance_sampling, axis=0) / (m.sqrt(runs))
##var_alg2 = np.std(ess_off_policy_importance_sampling_pd, axis=0) / (m.sqrt(runs))
##var_alg3 = np.std(ess_off_policy_multiple_importance_sampling, axis=0) / (m.sqrt(runs))
##var_alg4 = np.std(ess_off_policy_multiple_importance_sampling_pd, axis=0) / (m.sqrt(runs))
##
