...
print("Saving files")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_importance_sampling.csv", discounted_reward_off_policy_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_importance_sampling_pd.csv", discounted_reward_off_policy_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling.csv", discounted_reward_off_policy_multiple_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_cv.csv", discounted_reward_off_policy_multiple_importance_sampling_cv, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_cv_baseline.csv", discounted_reward_off_policy_multiple_importance_sampling_cv_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_pd.csv", discounted_reward_off_policy_multiple_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_cv_pd.csv", discounted_reward_off_policy_multiple_importance_sampling_cv_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_cv_pd_baseline.csv", discounted_reward_off_policy_multiple_importance_sampling_cv_pd_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated.csv", discounted_reward_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/discounted_reward_reinforce.csv", discounted_reward_reinforce, delimiter=",")

np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_importance_sampling.csv", policy_param_off_policy_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_importance_sampling_pd.csv", policy_param_off_policy_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling.csv", policy_param_off_policy_multiple_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_cv.csv", policy_param_off_policy_multiple_importance_sampling_cv, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_cv_baseline.csv", policy_param_off_policy_multiple_importance_sampling_cv_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_pd.csv", policy_param_off_policy_multiple_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_cv_pd.csv", policy_param_off_policy_multiple_importance_sampling_cv_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated.csv", policy_param_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_off_policy_multiple_importance_sampling_cv_pd_baseline.csv", policy_param_off_policy_multiple_importance_sampling_cv_pd_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_reinforce.csv", policy_param_reinforce, delimiter=",")

np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_importance_sampling.csv", gradient_off_policy_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_importance_sampling_pd.csv", gradient_off_policy_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling.csv", gradient_off_policy_multiple_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_cv.csv", gradient_off_policy_multiple_importance_sampling_cv, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_cv_baseline.csv", gradient_off_policy_multiple_importance_sampling_cv_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_pd.csv", gradient_off_policy_multiple_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_cv_pd.csv", gradient_off_policy_multiple_importance_sampling_cv_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated.csv", gradient_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_off_policy_multiple_importance_sampling_cv_pd_baseline.csv", gradient_off_policy_multiple_importance_sampling_cv_pd_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/gradient_reinforce.csv", gradient_reinforce, delimiter=",")

np.savetxt("./parallelAllNoAdaptive/ess_off_policy_importance_sampling.csv", ess_off_policy_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_importance_sampling_pd.csv", ess_off_policy_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling.csv", ess_off_policy_multiple_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_cv.csv", ess_off_policy_multiple_importance_sampling_cv, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_cv_baseline.csv", ess_off_policy_multiple_importance_sampling_cv_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_pd.csv", ess_off_policy_multiple_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_cv_pd.csv", ess_off_policy_multiple_importance_sampling_cv_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated.csv", ess_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/ess_off_policy_multiple_importance_sampling_cv_pd_baseline.csv", ess_off_policy_multiple_importance_sampling_cv_pd_baseline, delimiter=",")

np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_importance_sampling.csv", n_def_off_policy_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_importance_sampling_pd.csv", n_def_off_policy_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling.csv", n_def_off_policy_multiple_importance_sampling, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_cv.csv", n_def_off_policy_multiple_importance_sampling_cv, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_cv_baseline.csv", n_def_off_policy_multiple_importance_sampling_cv_baseline, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_pd.csv", n_def_off_policy_multiple_importance_sampling_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_cv_pd.csv", n_def_off_policy_multiple_importance_sampling_cv_pd, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated.csv", n_def_off_policy_multiple_importance_sampling_cv_pd_baseline_approximated, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/n_def_off_policy_multiple_importance_sampling_cv_pd_baseline.csv", n_def_off_policy_multiple_importance_sampling_cv_pd_baseline, delimiter=",")

stats_opt = iw.optimalPolicy(env, num_batch, 10, discount_factor, variance_action, episode_length) # Optimal policy

np.savetxt("./parallelAllNoAdaptive/discounted_reward_optimal.csv", stats_opt.disc_rewards, delimiter=",")
np.savetxt("./parallelAllNoAdaptive/policy_param_optimal.csv", stats_opt.policy_parameter, delimiter=",")
