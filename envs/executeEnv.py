...
def reinforceBaseline(env, num_episodes, batch_size, discount_factor=1.0):
    """
...
stats = reinforce(env, 100, 10, discount_factor=0.8)
stats_baseline = reinforceBaseline(env, 100, 10, discount_factor=0.8)
stats_opt = optimalPolicy(env, 100, 10)
#plot the statistics of the algorithm
plot.plot_algorithm_comparison(stats, stats_baseline, stats_opt, 100, smoothing_window=1)
