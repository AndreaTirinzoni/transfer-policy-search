...
def main():
    ...
    for estimator,learning_rate in zip(estimators, learning_rates):
        ...
        result = la.learnPolicy(env_param, simulation_param, source_dataset, name, off_policy=off_policy, features=polynomial)
...
estimators = ["IS", "MIS", "MIS-CV-BASELINE", "GPOMDOP"]#, "MIS-CV-BASELINE", "PD-MIS-CV-BASELINE"]
learning_rates = [8e-4, 8e-4, 8e-4, 8e-4]
num_batch = 120
